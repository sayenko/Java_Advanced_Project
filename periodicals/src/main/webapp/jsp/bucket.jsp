		...
		<div class="w3-sidebar" style="width: 10%">
			...
			<div class="list-group" style="margin-top: 40px">
				...
				<a href="/home" class="list-group-item">
					...
					<spring:message code='sidebar.home'/>
				</a>

				<security:authorize access="hasRole('ROLE_ADMIN')">
					<a href="/create-periodical" class="list-group-item">
						<i class="fa fa-search"></i><spring:message code='sidebar.create_periodical'/>
					</a>
				</security:authorize>

				<security:authorize access="hasRole('ROLE_USER')">
					<a href="/buckets" class="list-group-item">
						<i class="fa fa-search"></i> <spring:message code='sidebar.bucket'/>
					</a>
				</security:authorize>
				...
				<c:if test="${pageContext.request.userPrincipal.name != null}">
					...
					<a class="list-group-item" onclick="document.forms['logoutForm'].submit()" style="cursor: pointer">
						...
						<spring:message code='sidebar.logout'/>
					</a>
